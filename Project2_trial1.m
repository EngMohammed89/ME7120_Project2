...
if strcmp(mode,'make')
  ...
  bn5 =  [0.25 0.25 -0.25 -0.25];
  bn5d = [0.75 0.5 -0.25];
  bn5dd =[1.5 0.5];
  
  bn6 =  [0.25 0.25 -0.25 -0.25];
  bn6d = [0.75 0.5 -0.25];
  bn6dd =[1.5 0.5];
  
  bn7 =  [0.25 0.25 -0.25 -0.25];
  bn7d = [0.75 0.5 -0.25];
  bn7dd =[1.5 0.5];
  
  bn8 =  [0.25 0.25 -0.25 -0.25];
  bn8d = [0.75 0.5 -0.25];
  bn8dd =[1.5 0.5];
...
%   rn2d=[0.5];
  ...
  Kb=zeros(24,24);% For this beam, 2 nodes, 2DOF each, is a 4 by 4
                 % matrix. 
%   kb2=Kb; %Stiffness matrix for the x-z plane beam element. 
...
%   end
  ...
  for i=1:numbeamgauss
    ...
    Kb=Kb+bgpw(i)*beamsfs*beamsfs'*Izz*E*Jac;% This is the gauss
                                               % integration part
  end
